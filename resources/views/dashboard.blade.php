<x-app-layout>
   ...
   <div class="grid grid-cols-12 gap-0 bg-[#11212D]">
       ...
       <div class="col-span-10 bg-[#0C0D13] rounded-tl-md">
           <div class="p-8">
               @foreach(Auth::user()->getAllPermissions()->pluck('name') as $permName)
                   @if($permName == 'view dashboard')
